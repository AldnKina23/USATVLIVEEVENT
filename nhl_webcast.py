...
# Output Directory & Files Setup
OUTPUT_DIR = Path("UsaLiveEvent")
OUTPUT_VLC = OUTPUT_DIR / "NHLWebcast_VLC.m3u8"
OUTPUT_TIVI = OUTPUT_DIR / "NHLWebcast_TiviMate.m3u8"
...
def write_playlists(entries):
    ...
    Writes two files in UsaLiveEvent folder:
     - NHLWebcast_VLC.m3u8
     - NHLWebcast_TiviMate.m3u8
    """
    # Memastikan folder UsaLiveEvent dibuat otomatis jika belum ada
    ...
    log(f"Playlists saved in folder '{OUTPUT_DIR}': {OUTPUT_VLC.name}, {OUTPUT_TIVI.name}")
