...
VLC_OUTPUT_FILE = OUTPUT_DIR / "cdn_ch_filter_vlc.m3u8"
TIVIMATE_OUTPUT_FILE = OUTPUT_DIR / "cdn_ch_filter_tivimate.m3u8"
...
def generate_output_files():
    ...
    # Pastikan folder target ada sebelum menulis file
