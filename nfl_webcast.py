...
OUTPUT_VLC = OUTPUT_DIR / "NFLWebcast_VLC.m3u8"
OUTPUT_TIVI = OUTPUT_DIR / "NFLWebcast_TiviMate.m3u8"
...
def write_playlists(entries):
    # Memastikan folder UsaLiveEvent sudah dibuat
    ...
    log(f"Playlists saved in folder '{OUTPUT_DIR}'")
